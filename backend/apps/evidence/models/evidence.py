...
class EvidenceList(models.Model):
    ...
    merge_current = models.IntegerField(
        default=0,
        verbose_name="合并进度-已处理文件数",
    )
    merge_total = models.IntegerField(
        default=0,
        verbose_name="合并进度-总文件数",
    )
