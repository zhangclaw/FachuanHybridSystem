...
class Team(models.Model):
    ...
    team_type = models.CharField(max_length=16, choices=TeamType.choices, verbose_name="团队类型")
    law_firm = models.ForeignKey(LawFirm, on_delete=models.CASCADE, related_name="teams", verbose_name="所属律所")
