/**
 * admin_case_form_contract.js
 * 案件 Admin 表单 - 合同当事人动态过滤
 *
 * 根据案件绑定的合同，动态过滤 CaseParty inline 的 client 选择框，
 * 支持自动填充、选项恢复、加载状态管理等功能。
 *
 * 依赖: admin_case_form_utils.js（必须先加载）
...
;(function(global){
  ...
  var byId             = ns.byId;
  var refreshSelect2   = ns.refreshSelect2;
  ...
  // 暴露到命名空间
  // ============================================================
  ns.initContractPartyFilter = initContractPartyFilter;
  ns.handleInlineAdded       = handleInlineAdded;
