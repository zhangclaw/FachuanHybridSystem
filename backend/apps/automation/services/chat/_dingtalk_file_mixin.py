...
class DingtalkFileMixin:  # pragma: no cover
    ...
    async def _aget_access_token(self) -> str:  # 由 DingtalkTokenMixin 提供  # pragma: no cover
        raise NotImplementedError
    ...
    async def _aupload_media(self, file_path: str) -> str:  # pragma: no cover
        """异步版本。上传媒体文件到钉钉并获取 media_id"""
        try:
