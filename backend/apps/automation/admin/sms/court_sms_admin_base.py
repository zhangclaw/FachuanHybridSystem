...
class CourtSMSAdminBase(admin.ModelAdmin):
    ...
    def recommended_cases_display(self, obj: CourtSMS) -> SafeString:
        ...
        return format_html(
            ...
            "  return;"
            " }}"
            " var html='<div style=\"display:grid;grid-template-columns:repeat(auto-fill,minmax(320px,380px));gap:10px;\">';"
            ...
            "  html+="
            "   '<div class=\"rec-card\" data-id=\"'+r.id+'\" style=\"min-width:0;border:2px solid '+borderColor+';border-radius:6px;padding:12px 14px;background:#fff;box-sizing:border-box;position:relative;\">'"
