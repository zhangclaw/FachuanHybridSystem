...
class CourtSMSAdminBase(admin.ModelAdmin):
    ...
    def recommended_cases_display(self, obj: CourtSMS) -> SafeString:
        ...
        return format_html(
            ...
            "  html+="
            "   '<div class=\"rec-card\" data-id=\"'+r.id+'\" style=\"flex:1 1 320px;max-width:100%;border:2px solid '+borderColor+';border-radius:6px;padding:12px 14px;background:#fff;box-sizing:border-box;\">'"
